(function () {
  ...
  style.textContent = `
    ...
    .login-badge{position:fixed;right:18px;top:18px;z-index:12;display:flex;align-items:center;gap:10px;padding:8px 10px;border:1px solid rgba(255,255,255,.12);border-radius:8px;background:rgba(13,20,24,.82);color:#dce6ea;box-shadow:0 12px 34px rgba(0,0,0,.22)}
  ...
  async function backendExportBank() {
    requireLogin();
    const res = await fetch("/api/questions/export", { headers: authHeaders() });
